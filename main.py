...
def cifrarMurcielagoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Murcielago-Cifrar",texto,cifrarMurcielago(texto))
    return False
def descifrarMurcielagoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Murcielago-Descifrar",texto,descifrarMurcielago(texto))
    return False
...
def cifrarEucaliptoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Eucalipto-Cifrar",texto,cifrarEucalipto(texto))
    return False
def descifrarEucaliptoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Eucalipto-Descifrar",texto,descifrarEucalipto(texto))
    return False
#---CÓDIGO Cenit polar--------------------------------------------------------
def cifrarCenitPolarES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("CenitPolar-Cifrar",texto,cifrarCenitPolar(texto))
    return False
def descifrarCenitPolarES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("CenitPolar-Descifrar",texto,cifrarCenitPolar(texto))
    return False
#---CÓDIGO MORSE --------------------------------------------------------
def cifrarMorseES():
    """
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Morse-Cifrar",texto,cifrarMorse(texto))
    return False
def descifrarMorseES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Morse-Descifrar",texto,descifrarMorse(texto))
    return False
#-----SUFAMELICO --------------------------------------------------------
def cifrarSufamelicoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Sufamélico-Cifrar",texto,codigoSufamelico(texto))
    return False
def descifrarSufamelicoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Sufamélico-Descifrar",texto,codigoSufamelico(texto))
    return False
#---CÓDIGO Deletreo --------------------------------------------------------
def cifrarDeletreoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Deletreo-Cifrar",texto,cifrarDeletreo(texto))
def descifrarDeletreoES():
    ...
    if not validarVacio(texto):
        ...
        agregarBitacora("Deletreo-Descifrar",texto,descifrarDeletreo(texto))
    return False
